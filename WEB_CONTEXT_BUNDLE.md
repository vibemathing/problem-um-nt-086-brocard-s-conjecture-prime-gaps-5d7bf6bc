...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-086"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-v1",
      "problem_contract_sha256": "6061073b1f18e5f82bdcc4932df3fb3840b5bbd8845112ce8d8fc6a6fe29199f",
      "problem_id": "problem:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc",
      "route_id": "route:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-source-fidelity-01",
      "graph_id": "graph:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there always at least 4 primes between consecutive squares of primes $p_n^2$ and $p_{n+1}^2$?"
          },
          "statement_sha256": "b648b51467a91ed99a41667f6886cf779020fc0fc29910280a009109c80950b4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-root",
      "route_id": "route:um-nt-086-brocard-s-conjecture-prime-gaps-5d7bf6bc-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-086-4cbf2ec8296e",
        "url": "https://www.unsolvedmath.com/problems/NT-086"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
